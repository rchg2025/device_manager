  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 mb-6 flex flex-col md:flex-row flex-wrap gap-4 items-end">
      ...
      {(name || status || equipment || fromDate || toDate) && (
        <button type="button" onClick={handleClear} className="w-full md:w-auto bg-gray-100 text-gray-600 px-3 py-2 rounded-md hover:bg-gray-200 text-sm font-medium flex items-center justify-center gap-1 shrink-0 h-[38px]">
