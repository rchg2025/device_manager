...
export default function MaintenanceModal({ equipmentId, equipmentName, availableQty }: { equipmentId: string, equipmentName: string, availableQty: number }) {
  ...
  async function handleSubmit(formData: FormData) {
    setIsLoading(true)
    formData.append("classroomEqId", equipmentId)
    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden text-left max-h-[90vh] flex flex-col">
